function Contacts() {
  return (
    <div className="bg-[#fcfcfc] min-h-screen">
      ...
      <div className="bg-gradient-to-r from-red-50 to-orange-50 border-l-4 border-orange-500 p-8 mx-16 mt-16 rounded-r-lg">
        <p className="text-gray-700 text-xl italic font-['Sour_Gummy'] mb-3">
          Consegna a domicilio gratuita in tutta Gaggiano e comuni limitrofi!
        </p>
        <p className="text-gray-500">
          La Cometa è principalmente una pizzeria d'asporto, ma abbiamo anche
          qualche tavolino ed un bancone con sgabelli per poter gustare
          un'ottima pizza anche senza doverla portare a casa.
        </p>
      </div>
      ...
      <div className="max-w-[1100px] mx-auto px-6 py-16">
        <div className="text-center sm:mb-12 mb-4">
          ...
          <p className="text-gray-600 mt-4 max-w-2xl mx-auto">
            Vieni a trovarci o chiamaci per ordini e informazioni. Siamo sempre
            felici di aiutarti!
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="rounded-3xl overflow-hidden border border-gray-200/40 shadow-lg">
            <iframe
